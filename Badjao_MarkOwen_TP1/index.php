...
<body>
<?php
// This sector of PHP is for calculator please proceed further more
$total=0;
//value for operators
...
$PL = "PHP";
$info = "Hello World! I am an aspiring Programmer or Developer and I want to create something to help the others.";
//Programming1
...
<div class="w3-content" style="max-width:2000px;margin-top:46px">
  ...
  <div class="mySlides w3-display-container w3-center">
    <img src="Head.png" style="width:95%">
  ...
  <div class="mySlides w3-display-container w3-center">
    <img src="Head2.gif" style="width:95%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <h3></h3>
      <p><b></b></p>    
    </div>
  ...
  <div class="mySlides w3-display-container w3-center">
    <img src="Head3.jpg" style="width:95%">
    <div class="w3-display-bottommiddle w3-container w3-text-white w3-padding-32 w3-hide-small">
      <h3></h3>
      <p><b>The city never sleeps.</b></p>    
    </div>
  </div>

  <!-- The Project Section -->
  <div class="row header-content" id="projects">
		<div class="column-12">
			<?php echo $text1?>
		</div>
	</div> 
    <legend> 02 Laboratory Exercise 1 </legend>
    <fieldset>
    <div 
		<!-- end of div: header -->
		<div class="row">
...
<div class = "design1">
    <legend>03 Laboratory Exercise 1 </legend>
    <fieldset>
<form action="index.php" method="POST">
    <center> <h1> My Basic Calculator </h1>
        ...
        <input type="text" name="total" id="" value='<?php if(isset($_POST['submit'])) echo $_POST['total']?>' ></br>
  ...
  <!-- The About Section -->
  <div class="w3-black w3-container w3-content w3-padding-64" style="max-width:800px" id="about">
    <h2 class="w3-wide w3-center">Getting to know about me!</h2>
    <img src="Owen.png" style="width: 350px;">
    <p class="w3-opacity w3-center"><i>Aspiring Programmer!</i></p>
    <div class="w3-row w3-padding-32">
      <div class="w3-col m6 w3-large w3-margin-bottom">
      <p>Name: <?php echo "$FirstName"."  "."$middleIni". "  "."$LastName"?></p>
      </div>
      <p>Age: <?php echo "$age"?></p>
      <p>Address: <?php echo "$address"?></p>
      <p>Birthdate: <?php echo "$birthDate"?></p>
      <p>Occupation: <?php echo "$occupation"?></p>
      <p>Workplace/School: <?php echo "$school"?></p>
      <p>Place: <?php echo "$address"?></p>
      <p>Short info: <?php echo"$info"?>
    </div>
  </div>
...
<footer class="w3-container w3-padding-45 w3-center w3-opacity w3-light-grey w3-xlarge">
  ...
  <a href="https://www.facebook.com/owenkyouma1030/" class="fa fa-facebook"></a>
  <a href="https://twitter.com/newooooo123" class="fa fa-twitter"></a>
  <a href="https://www.youtube.com/channel/UCg6qS2BGlP0qZboRbgE7W6Q" class="fa fa-youtube"></a>
  <a href="https://www.linkedin.com/in/mark-owen-747341253/" class="fa fa-linkedin"></a>
  <p class="w3-medium"">Email: owenbadjao@gmail.com</p>
  <p class="w3-medium">Source Code here: <a href="https://www.w3schools.com/w3css/default.asp" target="_blank">w3.css</a></p>
  <p class="w3-medium">Fullfill for Task Performance: 2022</p>
  <a href="https://sticaloocan.edu.ph/home">STI Caloocan</a>
  <img src="STI.png" style="width: 100px;" class="fa">
</footer>
...
<style>
/*Sorry for the many code lines/blocks */
/*Source code is W3 School */
body {
...
h1{
    font-size:36px}h2{font-size:30px}h3{font-size:24px}h4{font-size:20px}h5{font-size:18px}h6{font-size:16px
    }
...
.w3-serif{
    font-family:serif}.w3-sans-serif{font-family:sans-serif}.w3-cursive{font-family:cursive}.w3-monospace{font-family:monospace
    }
h1,h2,h3,h4,h5,h6{
    font-family:"Segoe UI",Arial,sans-serif;font-weight:400;margin:10px 0}.w3-wide{letter-spacing:4px
    }
hr{
